...
public class OrderController {
    ...
    public ResponseEntity<String> addOrder(@RequestBody Order order){
        if(!orderService.isNewOrder(order)){
            return new ResponseEntity<>("Order already present", HttpStatus.ALREADY_REPORTED);
        }
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        if(!orderService.isNewDeliveryPartner(partnerId)){
            return new ResponseEntity<>("Partner already present", HttpStatus.ALREADY_REPORTED);
        }
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        ...
        if(!orderService.isUnassignedOrder(orderId)) {
